...
export default function Galaxy({
  ...
  const mergedClassName = ['galaxy-container', className].filter(Boolean).join(' ').trim();
  return <div ref={ctnDom} className={mergedClassName} style={style} {...restProps} />;
}
